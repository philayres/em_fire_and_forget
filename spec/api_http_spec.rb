...
describe '/email' do
  ...
  # it "send should send an email and pass to mailgun" do
  #   opt = {}


  #   params = {from: 'phil.ayres@repse.com', to: 'josh.chou@ses-technologies.com', subject: 'Hello!', message: 'A really boring message.'}
  #   path = '/email/send'
  #   @requester.make_request :post, params, path, nil
  #   @requester.body.should == "{\"url_params\":{},\"body_params\":{\"username\":\"any\",\"password\":\"anything\",\"abc_params\":\"blah\",\"def_params\":\"like\"}}"
